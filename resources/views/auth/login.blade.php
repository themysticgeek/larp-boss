@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => config('app.name', 'Laravel')])

@section('content')
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    <div class="col-md-9 ml-auto mr-auto mb-3 text-center">
      <h3>{{ __('We are building an open source web app for multi-city LARP organizations to get a handle on their admin stuff so players and game runners can focus on community and collaborative storytelling.') }} </h3>
    </div>
